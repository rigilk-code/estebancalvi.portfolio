...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Portrait + typographic play — single entrance sequence, plays once */}
      <motion.div
        variants={container}
        initial="hidden"
        animate="visible"
        className="relative z-10 flex flex-col lg:flex-row items-start gap-8 lg:gap-16 px-6 md:px-16 lg:px-40 py-16 lg:py-24"
      >
        <motion.div variants={fromLeft} className="flex-shrink-0 md:ml-8 lg:ml-0">
